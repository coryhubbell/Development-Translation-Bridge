...
║                    Generated by WordPress Bootstrap Claude™                 ║
╚════════════════════════════════════════════════════════════════════════════╝
...
- DIVI Builder (wpbc translate claude divi file.html)
- Elementor (wpbc translate claude elementor file.html)
- Avada Fusion (wpbc translate claude avada file.html)
- Bricks Builder (wpbc translate claude bricks file.html)
- WPBakery/VC (wpbc translate claude wpbakery file.html)
- Pure Bootstrap (wpbc translate claude bootstrap file.html)
...
HTML;
	 ...
	 *
	 * @param WPBC_Component $component Component being converted.
	 * @return string Header comment block.
	 */
	private function generate_component_header( WPBC_Component $component ): string {
...
│ EDITABLE: Yes (modify content, classes, or structure)
╰────────────────────────────────────────────────────────────────╯
-->
...
HTML;
	 ...
	 */
	private function generate_component_footer( WPBC_Component $component ): string {
		$type = ucwords( str_replace( '-', ' ', $component->type ) );
		return "\n<!-- End {$type} Component -->\n";
	}
